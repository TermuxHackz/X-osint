...
<hr>
# NOTE
<h1>YOU MAY ENCOUNTER ERROR WHEN TRYING TO INSTALL FOR LINUX OR TERMUX KINDLY BEST AS I AM WORKING ON A FIX AND I WOULD UPDATE THIS README FILE AND YOU CAN RECLONE AGAIN AND DELETE THE OLD REPO USING: 
```
cd $HOME
rm -rf X-osint
```
