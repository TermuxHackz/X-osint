...
# NOTE
<b>A new stable version is soon to be released in the coming weeks. The aim of this update is to get rid of bugs and add some new improvements to the program. Have any features you might want to add or possibly collaborate with Feel free to send an email to me </b> 
